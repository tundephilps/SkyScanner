...
const CabinClass = () => {
  ...
  return (
    <div className="border-r-4 border-purple-900 w-[18%]  flex items-center px-6 bg-white h-20 rounded-r-md relative ">
      ...
      {showOptions && ( // Render options container only if showOptions is true
        <div className="absolute bg-white w-[400px] p-4 rounded-md top-[120%] left-[0%]  ">
          {/* Close Button */}
          ...
          <div className=" h-[500px] overflow-y-auto px-6 ">
            <div className="flex flex-col gap-4 ">
              <p className="text-base text-slate-800 font-bold ">Cabin Class</p>
              <p className="text-base text-gray-600 font-bold ">
                We can only show Economy prices for this search
              </p>
              <p className="text-base text-gray-500 font-semibold ">
                To see Business and First Class options, please tell us your
                travel dates or destination.
              </p>
            </div>
            {/* Cart */}
            ...
            <p className="pt-6 text-xs font-semibold">
